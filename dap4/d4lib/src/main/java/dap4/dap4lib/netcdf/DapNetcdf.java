...
directly from netcdf4/src/main/java/ucar/nc2/jni/netcdf/
	Nc4prototypes.java
	SizeT.java
	SizeTByReference.java
All of them need a package name change and import simplications.
If any of the corresponding files in
netcdf4/src/main/java/ucar/nc2/jni/netcdf/
...
public interface DapNetcdf extends Library
{
    ...
    static final int NC_CLOBBER = 0;
    /**
     * < Destroy existing file. Mode flag for nc_create().
     */
    static final int NC_NOCLOBBER = 0x0004;
    /**
     * < Don't destroy existing file. Mode flag for nc_create().
     */
    static final int NC_DISKLESS = 0x0008;
    /**
     * < Create a diskless file. Mode flag for nc_create().
     */
    static final int NC_MMAP = 0x0010;
    /**
     * < Use diskless file with mmap. Mode flag for nc_open() or nc_create().
     */
    static final int NC_CLASSIC_MODEL = 0x0100;
    /**
     * < Enforce classic model. Mode flag for nc_create().
     */
    static final int NC_64BIT_OFFSET = 0x0200;
    /**
    ...
    int nc_get_att(int ncid, int varid, String name, Pointer bbuff); // other user defined types
