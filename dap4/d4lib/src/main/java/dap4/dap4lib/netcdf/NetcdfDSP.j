...
public class NetcdfDSP extends AbstractDSP
{
    ...
    static protected String DFALT_NETCDF4LIBNAME = "netcdf";
            ...
            throws DapException
    {
        ...
        for(int i = 0; i < nfields; i++) {
            ...
            if(ndims > 0) {
                ...
                dims = dimensionize(rootgroup, dimsizes);
            } else
                dims = new DapDimension[0];
            ...
            throws DapException
    {
        ...
        if(ndims > 0) {
            ...
            errcheck(ret = nc4.nc_inq_var(gid, varid, namep, basetypep, ndimsp, dimids, nattsp));
        } else
            dimids = new int[0];
